...
const Partners = () => {
  return (
    <section className="section-padding bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute inset-0 bg-gradient-radial from-transparent to-blue-50/80 z-0" />
      <div className="absolute top-10 right-10 w-60 h-60 bg-purple-500/5 rounded-full blur-3xl spin-slow" />
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-blue-400/10 rounded-full blur-3xl" />
      
      <div className="container-custom relative z-10">
        <AnimatedSection>
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="inline-block px-3 py-1 rounded-full bg-blue-500/10 text-blue-700 text-sm font-medium border border-blue-100 shadow-sm mb-4">
            ...
            {partners.map((partner, index) => (
              <div 
                ...
                className={`flex items-center justify-center p-6 rounded-xl ${
                  index % 4 === 0 ? 'gradient-card-purple' :
                  index % 4 === 1 ? 'gradient-card-blue' :
                  index % 4 === 2 ? 'gradient-card-teal' :
