...
const CompanyCarousel = () => {
  // Company/Partner images from wallets and blockchains
  const companies: CompanyImage[] = [
    // Blockchain partners
    { src: '/blockchains/bitcoin.png', alt: 'Bitcoin', name: 'Bitcoin' },
    { src: '/blockchains/ethereum.png', alt: 'Ethereum', name: 'Ethereum' },
    { src: '/blockchains/solana.png', alt: 'Solana', name: 'Solana' },
    { src: '/blockchains/xrp.png', alt: 'XRP', name: 'XRP' },
    // Wallet partners
    ...
    <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            Integrated with leading blockchain networks and wallet providers for seamless crypto management
          </motion.p>
        </div>
            ...
            {Array.from({ length: Math.ceil(companies.length / visibleItems.desktop) }).map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 ${
                  Math.floor(currentIndex / visibleItems.desktop) === index
                    ? 'bg-yellow-400 w-8'
        ...
        >
          <p className="text-gray-400 text-sm md:text-base">
            Join thousands of users who trust OFS Ledger for secure crypto management
          </p>
        </motion.div>
      </div>
    </section>
